...
import com.example.realestatelisting.utils.KeyProperties;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
            ...
            .authorizeHttpRequests(auth -> {
                ...
                auth.requestMatchers("/buyer/**").hasAnyRole("ADMIN","BUYER");
                auth.requestMatchers("/seller/**").hasAnyRole("ADMIN","SELLER");
                auth.requestMatchers("/agent/**").hasAnyRole("ADMIN","AGENT");
